...
if(!isset($_SESSION['username'])){
	header('Location: ' . '/login/?redirect='.'jchat/samplea.php');
	exit;
}
?>
...
session=<?=$_SESSION['username']?><br>
<a href="javascript:void(0)" onclick="javascript:chatWith('Edwin')">Chat With edwin</a>
