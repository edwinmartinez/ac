...
/*		echo 'calculatingImageSize...'.'<br>';
		echo 'maxWidth:'.$this->maxWidth.' width:'.$width.'<br>';
		echo 'maxHeight:'.$this->maxHeight.' width:'.$height.'<br>';*/
...
/*		echo 'currWidth:'.$this->currentDimensions['width']. ' currHeight:'.$this->currentDimensions['height'].'<br>';
		echo 'newWidth:'.$this->newDimensions['newWidth'].' newHeight:'.$this->newDimensions['newHeight'].'<br';*/
	...
	function crop() {
		...
		//imagefill($this->workingImage, 0, 0, $white ); //fill the bg with white
