<?php
//from http://www.catchmyfame.com/2007/07/28/finally-the-simple-pagination-class/
		...
		if($this->num_pages > 10)
		{
			...
			for($i=1;$i<=$this->num_pages;$i++)
			{
				...
				if($i==1 Or $i==$this->num_pages Or in_array($i,$this->range))
				{
					...
					$this->return .= ($i == $this->current_page And $_GET['page'] != 'All') ? "<strong><span class=\"current\">$i</span></strong> ":"<a class=\"paginate\" title=\"Go to page $i of $this->num_pages\" href=\"$_SERVER[PHP_SELF]?page=$i&ipp=$this->items_per_page$this->querystring\">$i</a> ";
				}
