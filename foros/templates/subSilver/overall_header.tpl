...
#container { 
	...
	#header { 
		...
		#logo { 
			background: url(/images/amigo_cupido_header.jpg) no-repeat left top; 
			width: 728px;
			height: 80px;
		...
		#topNav { 
			/*background: url(images/cita-en-linea.gif) no-repeat right top; */
...
<div id="container">
  <div id="logo"> <a href="http://www.amigocupido.com/"><img src="/images/spacer.gif" alt="Amigo Cupido" title="Citas En Linea" width="319" height="80" border="0" /></a>
  </div>
...
<table width="728" cellspacing="0" cellpadding="10" border="0" align="center"> 
	<tr> 
		<td class="bodyline"><table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr> 
				<td><a href="/mi_cuenta/">Mi Cuenta</a> / Mensajes <!--<a href="{U_INDEX}">&nbsp;</a>--></td>
